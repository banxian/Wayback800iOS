...
QImage QImageFromLocal(const char* filename)
{
    return QImage([[[NSBundle mainBundle] pathForResource:[NSString stringWithUTF8String:filename] ofType:nil] UTF8String]);
}